...
public class KaoshengchengjiController {
    ...
    public R page(@RequestParam Map<String, Object> params,KaoshengchengjiEntity kaoshengchengji,
		...
		if(tableName.equals("xuesheng")) {
			kaoshengchengji.setXuehao((String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("jiaoshi")) {
			kaoshengchengji.setJiaoshigonghao((String)request.getSession().getAttribute("username"));
		}
    ...
    public R info(@PathVariable("id") Long id){
		...
		kaoshengchengji = kaoshengchengjiService.selectView(new EntityWrapper<KaoshengchengjiEntity>().eq("id", id));
    ...
    public R value(@PathVariable("yColumnName") String yColumnName, @PathVariable("xColumnName") String xColumnName,HttpServletRequest request) {
        ...
        List<Map<String, Object>> result = kaoshengchengjiService.selectValue(params, ew);
    ...
    public R valueDay(@PathVariable("yColumnName") String yColumnName, @PathVariable("xColumnName") String xColumnName, @PathVariable("timeStatType") String timeStatType,HttpServletRequest request) {
        ...
        List<Map<String, Object>> result = kaoshengchengjiService.selectTimeStatValue(params, ew);
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
        for(Map<String, Object> m : result) {
            for(String k : m.keySet()) {
                if(m.get(k) instanceof Date) {
    ...
    public R group(@PathVariable("columnName") String columnName,HttpServletRequest request) {
        ...
        List<Map<String, Object>> result = kaoshengchengjiService.selectGroup(params, ew);
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
        for(Map<String, Object> m : result) {
            for(String k : m.keySet()) {
                if(m.get(k) instanceof Date) {
     ...
     * 分段统计
     */
    @RequestMapping("/sectionStat/kaoshichengji/kaoshileixing")
    @IgnoreAuth
    public R kaoshileixingkaoshichengjiSectionStat(HttpServletRequest request) {
        Map<String, Object> params = new HashMap<String, Object>();
        EntityWrapper<KaoshengchengjiEntity> ew = new EntityWrapper<KaoshengchengjiEntity>();
        String tableName = request.getSession().getAttribute("tableName").toString();
        if(tableName.equals("xuesheng")) {
        ...
        List<Map<String, Object>> result = kaoshengchengjiService.kaoshileixingkaoshichengjiSectionStat(params, ew);
        return R.ok().put("data", result);
    }
    ...
    public R count(@RequestParam Map<String, Object> params,KaoshengchengjiEntity kaoshengchengji, HttpServletRequest request){
        String tableName = request.getSession().getAttribute("tableName").toString();
        if(tableName.equals("xuesheng")) {
            kaoshengchengji.setXuehao((String)request.getSession().getAttribute("username"));
        }
        ...
        EntityWrapper<KaoshengchengjiEntity> ew = new EntityWrapper<KaoshengchengjiEntity>();
        int count = kaoshengchengjiService.selectCount(MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, kaoshengchengji), params), params));
